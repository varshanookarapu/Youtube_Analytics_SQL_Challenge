...
I put the dataset code in this file [Youtube Analytics Dataset](Youtube_Analytics_Dataset_Code) which you can copy paste in DB fiddle (https://www.db-fiddle.com/) and work on these challenges .  You can intially test the data set by using the following queries 
